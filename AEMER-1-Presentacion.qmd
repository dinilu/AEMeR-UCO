...
<style>
.slide-background {
  background: linear-gradient(to right, rgba(255, 255, 255, 1), rgba(255, 255, 255, 0)), url("img/Tema_1/Código.png");
  background-size: cover;
}
</style>


## ¿Qué es R? {.slide-background}
